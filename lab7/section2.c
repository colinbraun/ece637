...
int main(int argc, char **argv)
{
    ...
    Pair weights[25];
    weights[0].n = 1; weights[1].n = 1; weights[2].n = 1; weights[3].n = 1; weights[4].n = 1;
    weights[5].n = 1; weights[6].n = 2; weights[7].n = 2; weights[8].n = 2; weights[9].n = 1;
    weights[10].n = 1; weights[11].n = 2; weights[12].n = 2; weights[13].n = 2; weights[14].n = 1;
    weights[15].n = 1; weights[16].n = 2; weights[17].n = 2; weights[18].n = 2; weights[19].n = 1;
    weights[20].n = 1; weights[21].n = 1; weights[22].n = 1; weights[23].n = 1; weights[24].n = 1;
    for (int row = 2; row < original_img.height-2; row++) {
        for (int col = 2; col < original_img.width-2; col++) {
            ...
            for (int i = -2; i <= 2; i++) {
                for (int j = -2; j <= 2; j++) {
                    int index = (i+2)*5 + j+2;
                    window[index].m = img14gn_img.mono[row+i][col+j];
    ...
    save_grayscale_image_to_tiff_i(result, original_img.width, original_img.height, "2-img14gn-corrected.tif");
}
